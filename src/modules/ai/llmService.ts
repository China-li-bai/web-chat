...
import { callOpenAICompatibleChatCompletions } from './compat';
...
// moved to ./compat.ts: OpenAICompatCallOptions


// moved to ./compat.ts: callOpenAICompatibleChatCompletions
